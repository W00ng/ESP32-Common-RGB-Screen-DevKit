...
#define GPIO_LCD_BL     (GPIO_NUM_46)
...
#define GPIO_I2S_DIN     (GPIO_NUM_40)
...
#define GPIO_SDMMC_CLK  (GPIO_NUM_44)
#define GPIO_SDMMC_CMD  (GPIO_NUM_43)
#define GPIO_SDMMC_D0   (GPIO_NUM_45)
